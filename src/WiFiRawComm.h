...
class WiFiRawComm : public CommInterface {
 private:
  ...
  static void create_raw_frame(uint8_t* buffer, const uint8_t* dest_mac, const uint8_t* src_mac,
                               const uint8_t* data, size_t data_len, size_t* frame_len);
  static void parse_raw_frame(const uint8_t* frame, size_t frame_len, uint8_t* src_mac,
